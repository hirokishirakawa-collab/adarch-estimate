 ...
 *   ・中身は私（Claude）の案。宮本様（京都）の要望2本＋代表案1本
...
const PACKAGES = [
  {
    ...
    caseStudies: "",
    proposalNote: "宮本様（京都・Kyrie）8/21アンケートの要望「採用動画パッケージ」。フォーム営業で価格が見える方が反響を得やすい、との指摘を受けて固定価格で設計。価格は本部が確定。",
  },
  {
    ...
    caseStudies: "",
    proposalNote: "宮本様（京都・Kyrie）8/21アンケートの要望「路面店サイネージセット」。本部の Panelize（山口井筒屋で稼働中）を各拠点が売れる形に。価格は本部が確定。",
  },
  {
    ...
    caseStudies: "",
    proposalNote: "代表案（8/21 宮本様への返信で提示「京都市 XX人リーチパッケージ 月額固定15万円」）。TVerは手離れ・利益率ともにグループ最良＝主力の固定収益に。価格は本部が確定。",
  },
];
