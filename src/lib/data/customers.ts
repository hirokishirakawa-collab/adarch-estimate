...
// 拠点マスタ（既存14拠点 + 47都道府県）
// ---------------------------------------------------------------
const DEFAULT_BADGE = "bg-zinc-100 text-zinc-600 border-zinc-200";
...
export const BRANCH_MAP = {
  ...
  pref_iwate:     { id: "pref_iwate",     name: "岩手県",   code: "P03", badgeClass: DEFAULT_BADGE },
  pref_miyagi:    { id: "pref_miyagi",    name: "宮城県",   code: "P04", badgeClass: DEFAULT_BADGE },
  pref_akita:     { id: "pref_akita",     name: "秋田県",   code: "P05", badgeClass: DEFAULT_BADGE },
  pref_yamagata:  { id: "pref_yamagata",  name: "山形県",   code: "P06", badgeClass: DEFAULT_BADGE },
  pref_fukushima: { id: "pref_fukushima", name: "福島県",   code: "P07", badgeClass: DEFAULT_BADGE },
  pref_ibaraki:   { id: "pref_ibaraki",   name: "茨城県",   code: "P08", badgeClass: DEFAULT_BADGE },
  pref_tochigi:   { id: "pref_tochigi",   name: "栃木県",   code: "P09", badgeClass: DEFAULT_BADGE },
  pref_gunma:     { id: "pref_gunma",     name: "群馬県",   code: "P10", badgeClass: DEFAULT_BADGE },
  pref_saitama:   { id: "pref_saitama",   name: "埼玉県",   code: "P11", badgeClass: DEFAULT_BADGE },
  pref_chiba:     { id: "pref_chiba",     name: "千葉県",   code: "P12", badgeClass: DEFAULT_BADGE },
  pref_tokyo:     { id: "pref_tokyo",     name: "東京都",   code: "P13", badgeClass: DEFAULT_BADGE },
  pref_kanagawa:  { id: "pref_kanagawa",  name: "神奈川県", code: "P14", badgeClass: DEFAULT_BADGE },
  pref_niigata:   { id: "pref_niigata",   name: "新潟県",   code: "P15", badgeClass: DEFAULT_BADGE },
  pref_toyama:    { id: "pref_toyama",    name: "富山県",   code: "P16", badgeClass: DEFAULT_BADGE },
  pref_ishikawa:  { id: "pref_ishikawa",  name: "石川県",   code: "P17", badgeClass: DEFAULT_BADGE },
  pref_fukui:     { id: "pref_fukui",     name: "福井県",   code: "P18", badgeClass: DEFAULT_BADGE },
  pref_yamanashi: { id: "pref_yamanashi", name: "山梨県",   code: "P19", badgeClass: DEFAULT_BADGE },
  pref_nagano:    { id: "pref_nagano",    name: "長野県",   code: "P20", badgeClass: DEFAULT_BADGE },
  pref_gifu:      { id: "pref_gifu",      name: "岐阜県",   code: "P21", badgeClass: DEFAULT_BADGE },
  pref_shizuoka:  { id: "pref_shizuoka",  name: "静岡県",   code: "P22", badgeClass: DEFAULT_BADGE },
  pref_aichi:     { id: "pref_aichi",     name: "愛知県",   code: "P23", badgeClass: DEFAULT_BADGE },
  pref_mie:       { id: "pref_mie",       name: "三重県",   code: "P24", badgeClass: DEFAULT_BADGE },
  pref_shiga:     { id: "pref_shiga",     name: "滋賀県",   code: "P25", badgeClass: DEFAULT_BADGE },
  pref_kyoto:     { id: "pref_kyoto",     name: "京都府",   code: "P26", badgeClass: DEFAULT_BADGE },
  pref_osaka:     { id: "pref_osaka",     name: "大阪府",   code: "P27", badgeClass: DEFAULT_BADGE },
  pref_hyogo:     { id: "pref_hyogo",     name: "兵庫県",   code: "P28", badgeClass: DEFAULT_BADGE },
  pref_nara:      { id: "pref_nara",      name: "奈良県",   code: "P29", badgeClass: DEFAULT_BADGE },
  pref_wakayama:  { id: "pref_wakayama",  name: "和歌山県", code: "P30", badgeClass: DEFAULT_BADGE },
  pref_tottori:   { id: "pref_tottori",   name: "鳥取県",   code: "P31", badgeClass: DEFAULT_BADGE },
  pref_shimane:   { id: "pref_shimane",   name: "島根県",   code: "P32", badgeClass: DEFAULT_BADGE },
  pref_okayama:   { id: "pref_okayama",   name: "岡山県",   code: "P33", badgeClass: DEFAULT_BADGE },
  pref_hiroshima: { id: "pref_hiroshima", name: "広島県",   code: "P34", badgeClass: DEFAULT_BADGE },
  pref_yamaguchi: { id: "pref_yamaguchi", name: "山口県",   code: "P35", badgeClass: DEFAULT_BADGE },
  pref_tokushima: { id: "pref_tokushima", name: "徳島県",   code: "P36", badgeClass: DEFAULT_BADGE },
  pref_kagawa:    { id: "pref_kagawa",    name: "香川県",   code: "P37", badgeClass: DEFAULT_BADGE },
  pref_ehime:     { id: "pref_ehime",     name: "愛媛県",   code: "P38", badgeClass: DEFAULT_BADGE },
  pref_kochi:     { id: "pref_kochi",     name: "高知県",   code: "P39", badgeClass: DEFAULT_BADGE },
  pref_fukuoka:   { id: "pref_fukuoka",   name: "福岡県",   code: "P40", badgeClass: DEFAULT_BADGE },
  pref_saga:      { id: "pref_saga",      name: "佐賀県",   code: "P41", badgeClass: DEFAULT_BADGE },
  pref_nagasaki:  { id: "pref_nagasaki",  name: "長崎県",   code: "P42", badgeClass: DEFAULT_BADGE },
  pref_kumamoto:  { id: "pref_kumamoto",  name: "熊本県",   code: "P43", badgeClass: DEFAULT_BADGE },
  pref_oita:      { id: "pref_oita",      name: "大分県",   code: "P44", badgeClass: DEFAULT_BADGE },
  pref_miyazaki:  { id: "pref_miyazaki",  name: "宮崎県",   code: "P45", badgeClass: DEFAULT_BADGE },
