...
export const MEDIA_MATRIX: Record<MediaId, MediaDef> = {
  tver: {
    ...
    description:
      "民放公式テレビ配信サービス（月間4,470万ユーザー）。売り方の主力は市単位の「商圏網羅プラン」＝商圏のTVer視聴者の3人に1人へ月平均約5回届ける水準（推計値・保証値ではない）。市まるごとで月額24万円〜（例: 高松市58万円/月）、県まるごとで月額72万円〜。標準プランはスターター50万/スタンダード100万（推奨）/ドミナント200万（各/月・媒体費）。",
    strengths: [
