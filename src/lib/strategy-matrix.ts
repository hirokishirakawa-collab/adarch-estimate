...
export const MEDIA_MATRIX: Record<MediaId, MediaDef> = {
  tver: {
    ...
    description:
      "民放公式テレビ配信サービス（月間4,470万ユーザー）。売り方は2つ。①市町村プラン（既製の型・Webで申込可）＝1つの市区町村に15秒CM。人口5万人未満のエリアは月3万円の1プラン（6ヶ月以上）、5万人以上は人口で決まる3プラン（住民の200／50／20人に1人へ・最低月5万円・3ヶ月以上）。初回登録費・管理費なし・途中変更なし・配信終了後に結果報告。②大規模展開（オーダー）＝月額30万円以上・2エリア以上・週次報告の希望のどれか。設計・考査費15万円（初回）＋運用管理費（媒体費の20%・最低月5万円）。再生数・届く人数は目安で、お約束しない。具体的な額はOSのTVerシミュレーター・TVer申込リンクで出す。",
    strengths: [
    ...
    considerations: [
      "人口5万人未満のエリアは月3万円の1プラン（6ヶ月以上）／5万人以上は月5万円〜（3ヶ月以上）",
