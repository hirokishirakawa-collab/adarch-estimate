...
- プランは2つ（2026-09-13〜）。境目は「運用の手間」
  - **①市町村プラン（既製の型）**: 1つの市区町村・15秒・途中変更なし・配信終了後に結果報告。**初回登録費・管理費なし・値引きなし**。月額は市の人口で決まる3プラン（ライト／スタンダード（おすすめ）／フル）。最低料金は**人口5万人未満のエリア月3万円・6ヶ月以上／5万人以上月5万円・3ヶ月以上**。お客様はTVer申込ページでそのまま申込できる（案内URLは /dashboard/tver-order-link）
