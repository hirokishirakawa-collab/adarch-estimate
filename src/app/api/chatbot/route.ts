...
- プランは2つ（2026-09-13〜）。境目は「運用の手間」
  - **①市町村プラン（既製の型）**: 1つの市区町村・15秒・途中変更なし・配信終了後に結果報告。**初回登録費・管理費なし・値引きなし**。**人口5万人未満のエリアは「まちのプラン」月3万円の1つだけ（6ヶ月以上）**。5万人以上は人口で決まる3プラン（ライト／スタンダード（おすすめ）／フル・最低月5万円・3ヶ月以上）。TVerの在庫で使い切れなかった分は、返金・追加請求なしで配信期間を延ばして配信する。お客様はTVer申込ページでそのまま申込できる（案内URLは /dashboard/tver-order-link）
