...
- **広告賞ファインダー** (/dashboard/award-finder) — 全国・地方・国際の広告賞（174件）の応募時期・応募料・狙いやすさを地域と制作物の種類から検索。クリエイティブ提案時に「◯◯賞へのエントリーを含めた制作」として箔付けを提案するための道具。地元の広告協会賞・地方紙広告賞・ラジオ局CMコンテストは応募すれば入賞圏
