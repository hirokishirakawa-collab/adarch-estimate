...
- **広告賞ファインダー** (/dashboard/award-finder) — 全国・地方・国際の広告賞（174件）の応募時期・応募料・狙いやすさを地域と制作物の種類から検索。使いどころは制作の前ではなく納品のあと＝作品を渡した先に「せっかくなので◯◯賞に出しませんか」と追加で提案するための道具。地元の広告協会賞・地方紙広告賞・ラジオ局CMコンテストは応募料が無料〜数千円で、地元の制作会社の入賞も普通にある
