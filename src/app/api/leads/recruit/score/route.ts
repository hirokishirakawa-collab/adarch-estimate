...
企業リストを受け取り、採用活動の状況から営業リードとしての優先度をスコアリングしてください。

【前提（重要）】採用に積極的な会社＝「事業が動いていて投資余力がある会社」のフラグです。出口は採用動画の売り込みに限定せず、**通常の広告営業（TVer等の媒体・映像制作・SNS）でよい**。採用系の提案（採用動画・採用SNS）は入口・切り口のひとつとして扱ってください。
...
- コメントには採用タイプ（中途/新卒/両方）を踏まえた具体的な提案ヒントを含める。ただし採用動画の売り込み一辺倒にせず、「採用に投資中＝動いている会社」として通常の広告提案（集客・認知・媒体）につなげる視点も添える
