...
TVerのプラン（2026-09-13〜）: ①市町村プラン＝1つの市区町村・15秒。月額は市の人口で決まり、最低料金は人口5万人未満のエリア月3万円（6ヶ月以上）・5万人以上月5万円（3ヶ月以上）。初回登録費・管理費なし。②大規模展開＝月額30万円以上・2エリア以上・週次報告の希望のどれか。設計・考査費15万円（初回）＋運用管理費（媒体費の20%・最低月5万円）。具体的な額は書かず「OSのTVerシミュレーターで出す」と添える。
