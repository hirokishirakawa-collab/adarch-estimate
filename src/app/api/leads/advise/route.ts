...
媒体提案の考え方: 商圏のある地域企業には「予算◯万円で何回再生」ではなく**「御社の商圏は、いくらで押さえられます」という商圏単位の提案**が主力。TVerは市区町村単位で配信を絞れるため、市まるごとの網羅プランが県単位より現実的な予算で組める。再生数ではなく「リーチ人数」で話す。
期間の考え方: TVerは単月で売らず、**標準3ヶ月のキャンペーンで完結させる**提案にする。「商圏のTVer視聴者の3人に1人へ月平均約5回届く状態」を3ヶ月続けて、商圏での認知を取り切ってから効果を判断する設計（例: 高松市 月58万円×標準3ヶ月）。見積・提案書では月額と3ヶ月総額を必ず併記する。
