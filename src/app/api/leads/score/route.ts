...
[
  {
    ...
    "hypothesis": "口コミ3.2で認知に課題あり。Instagram未活用でSNS動画による集客強化の余地が大きい",
    "recommendedApproach": "Instagram動画4本+TVer月額10万円パッケージ",
    "dmText": "突然のご連絡失礼いたします。○○エリアで映像制作・広告をお手伝いしております、アドアーチの△△と申します。\\n\\n御社のお店を拝見し、素敵なお店だと感じました。現在、地域のお客様へのPRとして、Instagram向けのショート動画やTVer広告が非常に効果的な結果を出しております。\\n\\nもし少しでもご興味がございましたら、無料でご提案書をお作りいたしますので、お気軽にご返信ください。\\n\\nお忙しいところ恐れ入りますが、何卒よろしくお願いいたします。"
  }
]

【hypothesis（課題仮説）のルール】
- 1〜2行で、この企業が抱えていそうな課題を具体的に推測
- 口コミ評価、デジタル活用度、業種特性から導出
- 「〜の課題がある」「〜の余地が大きい」等の表現
- 数値予測は禁止（定性的に）

【recommendedApproach（推奨アプローチ）のルール】
- 1行で、最適な媒体・サービスの組み合わせを提案
- 具体的な媒体名を含める（TVer、Instagram、YouTube等）
- パートナーが提案書に使える粒度

【dmText（初回DM文）のルール】
- そのまま送信できる完成度の文章（100〜200文字程度）
- 最初の1行で自己紹介（「○○エリアで映像制作・広告をお手伝いしております、アドアーチの△△と申します」の△△はそのまま残す）
- 企業の特徴に触れる（業種・立地・口コミ等から1つ）
- 具体的なメリットを1つ（媒体名を含む）
- 押し売り感を出さない丁寧なトーン
- 改行は\\nで表現`;
