            ...
            <div className="space-y-5">
              ...
              <Field label="プロフィール画像">
                <div className="flex items-center gap-4">
                  <div className="relative w-20 h-20 rounded-full overflow-hidden bg-white/5 border border-white/10 shrink-0 flex items-center justify-center">
                    {avatarPreview ? (
                      <img src={avatarPreview} alt="プレビュー" className="w-full h-full object-cover" />
                    ) : (
                  ...
                  <div className="flex-1 space-y-1.5">
                    <label className="inline-flex items-center gap-1.5 px-3 py-2 rounded-lg bg-white/5 border border-white/10 text-white/60 text-xs font-medium hover:bg-white/10 hover:border-white/20 transition-all cursor-pointer">
                    ...
                    <p className="text-white/30 text-xs">顔写真やアイコン画像（自動で400x400にリサイズされます）</p>
                  </div>
                </div>
              </Field>
