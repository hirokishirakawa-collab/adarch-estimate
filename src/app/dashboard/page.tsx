      ...
      <div className="rounded-xl border border-sky-200 bg-gradient-to-br from-sky-50 via-blue-50 to-indigo-50 px-5 py-4">
        ...
        <div className="space-y-2.5">
          {[
            {
              date: "2026.08.26",
              title: "広告賞ファインダー（制作物の箔付け）",
              desc: "全国・地方・国際の広告賞174件の応募時期・応募料・狙いやすさを、あなたの県と制作物の種類から探せます（営業タブ）。地元の広告協会賞・地方紙広告賞・ラジオ局CMコンテストは応募すれば入賞圏＝「◯◯賞へのエントリーまで含めた制作」として提案に。「提案文をコピー」で1行を提案書へ",
              tag: "NEW",
            },
            {
              date: "2026.08.24",
