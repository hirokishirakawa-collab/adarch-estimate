      ...
      <div className="rounded-xl border border-sky-200 bg-gradient-to-br from-sky-50 via-blue-50 to-indigo-50 px-5 py-4">
        ...
        <div className="space-y-2.5">
          {[
            ...
            {
              date: "2026.09.10",
              title: "AIに「週次を出して」— OSにつないだAIが1週間の記録から週次共有の下書きを作り、確認して提出",
              desc: "AI連携（MCP）につないだ代表は、Claude / ChatGPT に「週次を出して」と言うだけで、この1週間の貴社の記録（声をかけた先・返事・活動記録・動いた商談・いちばん近い受注候補・先週書いた「来週やること」）から週次共有の下書きができます。Q1（調子）とQ5（サポート）はご本人が選び、下書きを直してから提出＝本部のグループサポートに「AI記録」の印つきで届きます（Claudeでは /weekly も使えます）。従来のフォームもそのまま使えます",
              tag: "NEW",
            },
            {
              date: "2026.09.09",
