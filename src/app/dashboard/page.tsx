      ...
      <div className="rounded-xl border border-sky-200 bg-gradient-to-br from-sky-50 via-blue-50 to-indigo-50 px-5 py-4">
        ...
        <div className="space-y-2.5">
          {[
            {
              date: "2026.09.08",
              title: "AI連携（MCP）— ブランドキットとOSの数字を、お使いのAIが直接取りに来る",
              desc: "ブランドキット画面の「AIと直接つなぐ」にあるURLを Claude / ChatGPT のカスタムコネクタに登録し、OSのGoogleアカウントで許可すると、材料をコピーして貼らなくてもAIが最新の材料を自分で読みます。あわせて、貴社拠点の顧客・商談・見積の品目、パッケージ台帳、TVerエリア別プラン、本部WikiもAIから読めます（読み取りのみ・書き込み不可。売上や金額の数字は出ません）。接続は同じ画面からいつでも解除できます。有料プランのカスタムコネクタ機能が必要です",
              tag: "NEW",
            },
            {
              date: "2026.09.04",
