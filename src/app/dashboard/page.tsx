          ...
          {[
            {
              ...
              desc: "OSにつないだAIに「唐津市の歯科に営業したい」と言うと、OSのリードを今週のシグナル・周年・AIスコア・連絡手段で「当たりやすい順」に並べ（営業お断りと全社の送付済み台帳で除外）、全社の受注の決め手と返信が来た文面を「型」として添え、着地（TVer申込ページ・貴社の公式LINE・業種×市のLP）まで返します。文面は1社ずつAIが書き、「Gmailの下書き」にした時点でOSの送付記録（送付日・全社の送付台帳・事例DBの元）が残ります。送信ボタンは人が押します。業種×市のLP（/lp/…）はAIが文面を書き、市のTVer視聴者数・標準プラン・月額目安はOSから自動表示＝数字が狂いません。「返信あり」「受注」を記録した瞬間、グループの案件進捗スペースに1行流れ、その文面は全社が引けるようになります。あわせて、市を指定した少額のMeta広告（例: 日額500円・7日）をAIが組む仕組みも入りました（本部のMeta広告アカウント接続後に実出稿・バナーはOSの数字で描く）",
              tag: "NEW",
            },
            {
              date: "2026.09.09",
