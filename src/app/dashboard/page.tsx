      ...
      <div className="rounded-xl border border-sky-200 bg-gradient-to-br from-sky-50 via-blue-50 to-indigo-50 px-5 py-4">
        ...
        <div className="space-y-2.5">
          {[
            {
              date: "2026.09.16",
              title: "GROUP LIVEに「顧客登録」が流れるように",
              desc: "新しいお客様をOSに登録すると、ACTIVITY FEEDに「顧客登録」として流れます（社名・業種・都道府県まで／金額・連絡先・メモは出ません）。行を押すと、段階・登録日・登録した人・入口・商談の件数が開き、そのまま顧客ページへ移れます。これまでは商談を起こしたときだけ流れていたので、登録した時点からグループに見えるようになりました。",
              tag: "機能追加",
            },
            {
              date: "2026.09.15",
