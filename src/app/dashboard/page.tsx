          ...
          {[
            {
              ...
              desc: "ブランドキット画面の「AIと直接つなぐ」にあるURLを Claude / ChatGPT のカスタムコネクタに登録し、OSのGoogleアカウントで許可すると、材料をコピーして貼らなくてもAIが最新の材料を自分で読みます。あわせて、貴社拠点の顧客・商談・見積、パッケージ台帳、TVerエリア別プラン、本部Wiki、自分の月次の数字もAIから読めます（読み取りのみ・書き込み不可）。接続は同じ画面からいつでも解除できます。有料プランのカスタムコネクタ機能が必要です",
              tag: "NEW",
            },
            {
              date: "2026.09.04",
