      ...
      <div className="rounded-xl border border-sky-200 bg-gradient-to-br from-sky-50 via-blue-50 to-indigo-50 px-5 py-4">
        ...
        <div className="space-y-2.5">
          {[
            ...
            {
              date: "2026.08.18",
              title: "会社内容がメモに自動で入る／担当も自動で決定",
              desc: "事業の概要・口コミ要約・独立かチェーンかが、保存と同時にメモ欄へ。担当のいないリードは、ステータスを変えるかメモを書いた方が自動で担当になります",
              tag: "機能追加",
            },
            {
              date: "2026.08.18",
              title: "月次の売上報告が明細形式に",
              desc: "案件ごとに1行ずつ入力し、行ごとに請求元（自分で請求／本部から請求）を選べます。税抜を入れれば税込は自動計算されます",
              tag: "リリース",
            },
            {
              date: "2026.06.24",
            ...
            },
            {
              date: "2026.06.19",
              title: "あなたの営業数値",
              desc: "ダッシュボードに、ご自身の探客・アプローチ・受注・エリア攻略率を表示（ご本人のみ）。動いた分がひと目で分かります",
              tag: "NEW",
            },
          ].map((item) => (
            <div
