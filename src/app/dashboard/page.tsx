        ...
        <div className="space-y-2.5">
          {[
            ...
            },
            {
              ...
              desc: "TVerを「市町村プラン」と「大規模展開」の2つに整理しました。1つの市区町村に15秒で出す市町村プランは、初回登録費・管理費なしで、人口5万人未満のエリアなら月3万円（6ヶ月以上）、5万人以上なら月5万円（3ヶ月以上）から。お客様はTVer申込リンクからそのまま申込できます。月額30万円以上・2エリア以上・週次報告のご希望は大規模展開として個別に設計します。TVerシミュレーターは市区町村を選ぶだけでどちらのプランかを判定し、手数料まで出します。LP・AI連携・アーチくんの数字もすべて同じ額にそろえました（再生数・届く人数は目安です）",
              tag: "NEW",
            },
            {
              date: "2026.09.13",
