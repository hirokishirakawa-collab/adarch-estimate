      ...
      <div className="rounded-xl border border-sky-200 bg-gradient-to-br from-sky-50 via-blue-50 to-indigo-50 px-5 py-4">
        ...
        <div className="space-y-2.5">
          {[
            {
              date: "2026.08.26",
              title: "広告賞ファインダー（クライアントとの会話のきっかけに）",
              desc: "全国・地方・国際の広告賞174件の応募時期・応募料を、あなたの県と制作物の種類から探せます（営業タブ）。制作前・制作中・完了後のどの段階でも「せっかくなので◯◯賞に出しませんか」をクライアントとの会話のきっかけの一つにできます。地元の賞は応募料が無料〜数千円で、地元の制作会社の入賞も普通にあります",
              tag: "NEW",
            },
            {
              date: "2026.08.24",
