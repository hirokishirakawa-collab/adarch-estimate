...
export function LegalFooter() {
  return (
    <footer className="footer">
      ...
      <p>
        販売価格：選択した市区町村・プランの媒体費（画面に表示。人口5万人未満のエリアは月額30,000円の1プラン、5万人以上のエリアは人口に応じて算出・下限50,000円）＋消費税。初回登録費・管理費はかかりません。
        <br />
        契約期間：3・6・12ヶ月（人口5万人未満のエリアは6ヶ月以上）。
        <br />
        支払時期：月払い。初月分は発注書へのご署名の後（カード決済または請求書発行から7日以内の銀行振込）、2ヶ月目以降は配信開始日の各月応当日まで。ご相談・Web面談・お電話の段階では料金は発生しません。
        <br />
        返金条件：業態考査で出稿不可の場合は発注書を発行せず料金は発生しません。契約後、動画のクリエイティブ考査で出稿不可となった場合は全額返金。その他は申込規約第7条による。
      </p>
