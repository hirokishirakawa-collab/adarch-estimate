  ...
  "/dashboard/studio/sns-formats": [
    {
      popover: {
        title: "SNSフォーマット",
        description: "バズっている参考動画のURLを貼るだけで、構成・テロップ・フック技法をAIが自動解析。抽出したフォーマットでクライアントの動画を自動制作できます。",
      },
    },
    {
      ...
      popover: {
        ...
        description: "Instagram リールや TikTok のURLと再生数を入力して「解析する」を押します。AIが動画を解析し、構成タイムライン・テロップスタイル・フック技法・撮影のコツを自動抽出します。",
        side: "bottom",
      },
    },
    {
    ...
    {
      popover: {
        title: "③ 撮影依頼書をクライアントに渡す",
        description: "カード詳細画面の「撮影依頼書」セクションから、テキストコピー（LINEやメール用）またはPDF書き出し（印刷用）ができます。撮影カット・基本ルール・撮影のコツ・素材送付方法が含まれます。",
      },
    },
    {
      popover: {
        title: "④ 制作コマンドで自動編集",
        description: "クライアントから素材が届いたら、カード詳細の「制作コマンド」をコピーして、Premiere Pro連携済みのClaudeに貼り付けるだけ。素材パスを指定すると自動編集が実行されます。",
      },
    },
    {
      popover: {
        title: "💡 使い方のコツ",
        description: "同業種のバズ動画を5〜10本解析しておくと、クライアントに「このフォーマットで作りましょう」と提案しやすくなります。再生数も記録しておくと、どの構成が効果的かデータで判断できます。",
      },
    },
  ],
