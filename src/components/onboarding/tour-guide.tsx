...
const TOURS: Record<string, TourStep[]> = {
  ...
  "/dashboard/studio/sns-formats": [
    ...
    },
    {
      ...
      popover: {
        title: "② フォーマット一覧",
        description: "解析したフォーマットがキャプチャ画像付きで自動追加されます。業種フィルターや再生数ソートで整理できます。カードをクリックすると詳細と制作コマンドを確認できます。",
        side: "top",
      },
    },
    {
      popover: {
        title: "③ 制作の流れ",
        description: "フォーマット一覧からカードをクリック → 制作コマンドをコピー → Premiere連携のClaudeに貼り付け → 素材パスを入力するだけで自動編集が完了します。",
      },
    },
    {
      popover: {
