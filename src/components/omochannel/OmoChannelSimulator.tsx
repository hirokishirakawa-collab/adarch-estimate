...
import { type Target, type Area, type Dur, type Period, type InfoPeriod, PERIODS, INFO_PERIODS_JP, INFO_PERIODS_IB, JP_PRICES, IB_PRICES, INFO_JP, INFO_IB, MIRRORING_MONTHLY, VOD_PRICES, AREA_META } from "@/lib/media/omochannel";
