...
// ----------------------------------------------------------------
// 振込先口座（Ad Arch が受け取る側＝請求書PDF用）
//   ※ 支払明細書はパートナー口座（GroupCompany）を使うため、ここは本部口座専用。
// ----------------------------------------------------------------
export const BILLING_ACCOUNTS = [
  { bank: "三菱UFJ銀行", branch: "青山支店（608）", type: "普通", number: "0502921", holder: "アドアーチカブシキガイシャ" },
  { bank: "GMOあおぞらネット銀行", branch: "法人第二営業部", type: "普通", number: "1772923", holder: "Ad Archカブシキガイシャ" },
  { bank: "三井住友銀行", branch: "トランクNORTH支店", type: "普通", number: "0584070", holder: "アドアーチカブシキガイシャ" },
] as const;
