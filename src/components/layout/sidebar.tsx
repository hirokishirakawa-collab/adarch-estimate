...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: "広告賞ファインダー（クライアントとの会話のきっかけ）",
        icon: Award,
        minRole: "USER",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: "/dashboard/tver-order-link",
        label: "TVer申込リンク",
        icon: Tv2,
        minRole: "USER",
      },
...
const SELL_TAB_ITEMS: NavItem[] = [
  ...
  { href: "/dashboard/tver-order-link", label: "TVer申込リンク（お客様に渡す）", icon: Tv2, minRole: "USER" },
  { href: "/dashboard/tver-reports", label: "TVer配信実績", icon: BarChart2, minRole: "USER" },
