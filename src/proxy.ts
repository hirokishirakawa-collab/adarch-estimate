...
export const config = {
  matcher: [
    ...
    "/((?!api/auth|api/mcp|api/oauth|oauth/|\\.well-known|api/version|api/cron|api/packages/image/|api/line/webhook|api/square/webhook|l/|f/|api/contact|api/signage/d|signage/player|api/lp-view|api/franchise-leads/intake|api/franchise-leads/booking-signal|api/group-support|api/portfolio/sync|api/tracking|api/telegram|api/storage|api/creators|group-support/submit|move|feedback/|order/|lp/|api/banner/|api/tver-order/|test-form|p/|partner|creators|dashboard/studio/share/|_next/static|_next/image|favicon.ico|logo-adarch\\.png|logo_white\\.png|groupLogo_yoko_White\\.png|public).*)",
  ],
};
