...
export const config = {
  matcher: [
    "/((?!api/auth|api/cron|api/group-support|api/portfolio/sync|api/tracking|group-support/submit|p/|_next/static|_next/image|favicon.ico|logo-adarch\\.png|public).*)",
  ],
};
