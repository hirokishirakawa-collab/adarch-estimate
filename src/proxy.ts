...
export const config = {
  matcher: [
    "/((?!api/auth|api/cron|api/group-support|api/auto-sales/check-replies|api/auto-sales/check-responses|api/auto-sales/weekly-report|api/portfolio/sync|api/tracking|api/telegram|api/storage|group-support/submit|p/|dashboard/studio/share/|_next/static|_next/image|favicon.ico|logo-adarch\\.png|logo_white\\.png|groupLogo_yoko_White\\.png|public).*)",
  ],
};
