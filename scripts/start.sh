...
mkdir -p /data/storage/billing-pdfs /data/storage/group-sync-files /data/storage/media-files /data/storage/card-images /data/storage/video-reviews /data/storage/video-reviews/frames 2>/dev/null || true
